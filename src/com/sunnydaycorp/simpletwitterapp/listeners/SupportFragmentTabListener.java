...
public class SupportFragmentTabListener<T extends Fragment> implements TabListener {
	...
	// new SupportFragmentTabListener<SomeFragment>(R.id.flContent, this,
	// "first", SomeFragment.class, myFragmentArgs))
	public SupportFragmentTabListener(int fragmentContainerId, FragmentActivity activity, String tag, Class<T> clz, Bundle args) {
		mActivity = activity;
		mTag = tag;
		mClass = clz;
		mfragmentContainerId = fragmentContainerId;
	...
	public void onTabSelected(Tab tab, FragmentTransaction sft) {
		String formattedName = "<b>" + tab.getText().toString() + "</b>";
